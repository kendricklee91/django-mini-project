...
SECRET_KEY = ')m)=p-@j_6eg(bwav)zawi)uj+ze-(0vmbokg!7jp03*3rxn1l'
...
LOGIN_URL = reverse_lazy('login') # 'login' : accounts/login/
LOGIN_REDIRECT_URL = reverse_lazy('home') # 'root': board/main.html
LOGOUT_REDIRECT_URL = reverse_lazy('home') # 'root': board/main.html